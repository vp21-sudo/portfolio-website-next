...
const CircularProgressBar = ({ percentage }: Props) => {
  return (
    <div className="relative flex justify-center items-center w-full">
        <h1 className=' text-xl font-bold px-4 '>Your Progress!</h1>
      <div className="overflow-hidden flex justify-center items-center h-12 w-2/3 border-2 border-gray-300">
