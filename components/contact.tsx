                            ...
                            <>
                                ...
                                <form action={formAction} >
                                    <div className=' w-full flex flex-col justify-center items-center'>
                                        <input type="text" placeholder='Name' required name='name' className=' w-full md:w-4/5 p-2 rounded-lg bg-slate-200 border-2 border-slate-50 text-slate-900 mb-2 text-lg md:text-2xl font-medium' />
                                        <input type="email" placeholder='Email' required name='email' className=' w-full md:w-4/5 p-2 rounded-lg bg-slate-200 border-2 border-slate-50 text-slate-900 mb-2 text-lg md:text-2xl font-medium' />
                                        <textarea placeholder='Message' rows={5} name='message' className=' resize-none w-full md:w-4/5 p-2 rounded-lg bg-slate-200 border-2 border-slate-50 text-slate-900 mb-2 text-lg md:text-2xl font-medium' />
                                        <Submit/>
                                    </div>
                                </form>
                            </>
